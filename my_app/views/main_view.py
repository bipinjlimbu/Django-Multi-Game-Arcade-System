...
def leaderboard_view(request, game_slug):
    ...
    elif game.slug == 'reaction-game' or game.slug == 'math-challenge' or game.slug == 'arrow-defense' or game.slug == 'whack-a-mole' or game.slug == 'memory-flash-number' or game.slug == 'odd-one-out' or game.slug == 'rock-paper-scissors' or game.slug == 'pattern-memory':
        players = Leaderboard.objects.filter(game=game).order_by('-score')
